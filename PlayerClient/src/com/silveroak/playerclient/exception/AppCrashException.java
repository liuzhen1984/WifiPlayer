package com.silveroak.playerclient.exception;
...
import com.silveroak.playerclient.constants.DateConstant;
...
public class AppCrashException implements UncaughtExceptionHandler {
    ...
    //用于格式化日期,作为日志文件名的一部分
    private DateFormat formatter = DateConstant.LOG_FILE_TIME;
